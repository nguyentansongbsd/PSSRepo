...
{
    public class Action_CustomerNotices_Generate_Backup : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            //if (string.IsNullOrWhiteSpace(pro) && string.IsNullOrWhiteSpace(blo) && string.IsNullOrWhiteSpace(flo) && string.IsNullOrWhiteSpace(units))
            //{
            //    throw new InvalidPluginExecutionException("khong co pro blo flo unit");
            //}
