...
namespace Action_Approved_Updateduedate_Master
{
    public class Action_Approved_Updateduedate_Master : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            Entity enDetail = service.Retrieve("bsd_updateduedatedetail", new Guid(context.InputParameters["detail_id"].ToString()), new Microsoft.Xrm.Sdk.Query.ColumnSet(true));
            ...
            var enInstallmentRef = (EntityReference)enDetail["bsd_installment"];
