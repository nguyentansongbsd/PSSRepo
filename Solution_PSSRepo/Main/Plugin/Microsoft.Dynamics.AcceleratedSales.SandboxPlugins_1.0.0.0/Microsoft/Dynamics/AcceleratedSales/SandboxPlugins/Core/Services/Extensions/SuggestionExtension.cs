...
// Type: Microsoft.Dynamics.AcceleratedSales.SandboxPlugins.Core.Services.Extensions.SuggestionExtension
...
{
  public class SuggestionExtension : IDataExtension
  {
      ...
      HashSet<string> skipFormattingAttributes)
    {
      ...
      Dictionary<string, AttributeTypeCode?> dictionary1 = ((IEnumerable<AttributeMetadata>) metadata.GetAttributes("msdyn_salessuggestion")).ToDictionary<AttributeMetadata, string, AttributeTypeCode?>((Func<AttributeMetadata, string>) (a => a.LogicalName), (Func<AttributeMetadata, AttributeTypeCode?>) (a => a.AttributeType));
      HashSet<string> attributesToSkipFormatting = new HashSet<string>()
      {
    ...
    {
      string str;
      return record.TryGetValue("msdyn_relatedrecord", out str) ? JsonConvert.DeserializeObject<EntityExtensions.AttributeValue>(str) : new EntityExtensions.AttributeValue();
    }
    ...
    {
      metadataQueryParams.Entities.Add("msdyn_salessuggestion");
      ...
      if (layout == null)
        return;
      layout.PreprareLayoutMetadata("msdyn_salessuggestion", metadataQueryParams);
    }

    internal static KeyValuePair<string, IDataExtension> Create()
    {
      return new KeyValuePair<string, IDataExtension>("msdyn_salessuggestion", (IDataExtension) new SuggestionExtension());
    }
  }
}
