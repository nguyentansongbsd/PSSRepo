...
using System;
using System.Text;
namespace Action_Account_Loyalty
{
    public class Action_Account_Loyalty : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (allOrders.Entities.Count > 0 && allOrders[0].Attributes.Contains("sumtotalamount") && allOrders[0]["sumtotalamount"] != null)
            {
            ...
            if (loyaltyResults.Entities.Count > 0)
            {
                ...
                if (matchedProgram.Contains("bsd_membershiptier"))
                {
                    ...
                    Entity updateCustomer = new Entity("account", Guid.Parse(id))
                    {
