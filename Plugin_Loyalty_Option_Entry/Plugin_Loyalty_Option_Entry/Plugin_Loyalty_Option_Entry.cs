...
namespace Plugin_Loyalty_Option_Entry
{
    public class Plugin_Loyalty_Option_Entry : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (target.Contains("bsd_signeddadate") || target.Contains("bsd_signedcontractdate") || (target.Contains("statuscode") && ((OptionSetValue)target["statuscode"]).Value == 100000006))
            {
