...
namespace Action_AgingSimulation_Calculation
{
    public class Action_AgingSimulation_Calculation : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            else if (input01 == "Buoc 05" && input02 != "" && input03 != "" && input04 != "")
            {
            ...
            else if (input01 == "Buoc 06" && input02 != "" && input04 != "")
            {
        ...
        private void CreateAgingDetail(Entity InterestOption)
        {
            ...
            updateNewInterestAmount(enOptionEntry1, InterestOption, bsd_type1);
        ...
        private void updateNewInterestAmount(Entity enOptionEntry, Entity enInterestSimulateOption, int reportype)
        {
            ...
            if (cap != -100599)
            {
                ...
                traceService.Trace("cap: " + cap);
                traceService.Trace("sumInterestAmount: " + sumInterestAmount);
                traceService.Trace("encolInterestSimulationDetail.Entities.Count: " + encolInterestSimulationDetail.Entities.Count);
