            ...
            else if (input01 == "Bước 02" && input02 != "" && input03 != "" && input04 != "")
            {
                ...
                if (pm_statuscode == 1)  // payment = active
                {
                    ...
                    if (optionentryEn != null)
                    {
                        ...
                        if (!optionentryEn.Contains("bsd_qualifieddate") && bsd_totalpercent >= decimal.Parse((949 / 10).ToString()) && checkPaid_interest_main_mana_Installment(optionentryEn.Id) && enmis != null && enmis.Entities.Count == 0)
                            oe_tmp["bsd_qualifieddate"] = pm_ReceiptDate;
